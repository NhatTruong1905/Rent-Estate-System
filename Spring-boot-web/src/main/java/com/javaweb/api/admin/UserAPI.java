...
public class UserAPI {
    ...
    @PostMapping
    public ResponseEntity<?> createUsers(@Valid @RequestBody UserRegisterDTO newUser, BindingResult bindingResult) {
        ...
        return ResponseEntity.ok().body(userService.insert(newUser));
    }

    @PutMapping("/{id}")
    public ResponseEntity<?> updateUsers(@PathVariable("id") long id, @Valid @RequestBody UserRegisterDTO updateUser,
        ...
        return ResponseEntity.ok().body(userService.update(id, updateUser));
    }
